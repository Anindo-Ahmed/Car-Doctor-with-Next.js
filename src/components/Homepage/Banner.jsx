    ...
    <div className="carousel w-full mt-10">
      {banners.map((banner, index) => (
        <div
          ...
          key={index}
          id="slide"
          className="carousel-item relative w-full bg-no-repeat bg-cover h-[70vh] rounded-xl"
        >
          <div className="flex flex-col justify-center px-24 gap-8">
            ...
            <Link href={"/"}><button className="btn btn-outline border-white text-white hover:bg-white hover:text-black rounded-md px-6 py-2 text-lg">Latest Project</button></Link>
            </div>
          </div>
